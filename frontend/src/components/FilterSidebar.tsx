...
const Sidebar = styled(Box)({
  ...
  height: "calc(100% - 40px)", // Adjust height based on the padding above that gives 20px to the top and bottom side of the sidebar. This avoids overflow on the Navbar/Footer
});
